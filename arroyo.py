...
while user_input != 4:
    print("---------------------------------")
    print("Greetings, John Matthew Saraga Arroyo")
    print("1. Basic Info")
    print("2. Goals")
    ...
    if user_input == 1:
        ...
        print("Favorite Food: Chicken Curry")
        print("Favorite Anime: One Piece")
        
    elif user_input == 2:
        print("My goals are: ")
        print("-graduate college and become a good programmer by developing my IT skills")
